...
Para instalar todos los paquetes de bioconductor requeridos para este TP, vamos a usar el paquete Biocmanager:
...
Además de las herramientas específicas para trabajar con datos de secuencias, vamos a usar otras que sirven
para, por ejemplo, manejar más fácilmente las tablas de datos o generar gráficos elaborados. PAra instalarlos, definimos una lsita de nombres (cran.p), que luego pasamos a la función install.packages. 
...
Hay un último paquete que vamos a necesitar y que, como es muy pesado para descargar e instalar desde la nube, es necesario cargarlo manualmente al espacio de trabajo de R cloud. Para esto, selecciones la carpeta DESeq2, click en el engranaje que dice *More > Move...*, vamos hasta ../lib/x86_64-pc-linux-gnu-library/4.2/, click en Choose.

Para ver si la instalación de paquetes, y la carga manual de DESeq2, funcionaron, vamos a intentar "abrir" estos paquetes (cargarlos en el espacio de trabajo) con la función library.
...
Si todos dieron TRUE, entonces ya puede seguir con el TP.
